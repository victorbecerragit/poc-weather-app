...
<div align="center">
  <div style="display:inline-block;padding:14px 18px;border-radius:16px;border:1px solid #2df2ff;background:#0f1118;color:#f7f4ff;font-family:Arial,sans-serif;">
    ...
    <div style="font-size:28px;font-weight:700;margin:6px 0;">☀️ 4.2&deg;C</div>
    <div style="font-size:12px;color:#9c98ad;">Updated 2026-03-28T06:00</div>
...
| --- | --- | --- | --- | --- | --- | --- |
| 2026-03-28T06:00 | 4.2 | 71 | 4.7 | 266 | 0.0 | 0 ☀️ |
<!-- WEATHER:END -->
