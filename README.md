...
<div align="center">
  <div style="display:inline-block;padding:14px 18px;border-radius:16px;border:1px solid #2df2ff;background:#0f1118;color:#f7f4ff;font-family:Arial,sans-serif;">
    ...
    <div style="font-size:28px;font-weight:700;margin:6px 0;">☀️ 18.1&deg;C</div>
<<<<<<< HEAD
    <div style="font-size:12px;color:#9c98ad;">Updated 2026-03-24T16:15</div>
    <div style="margin-top:8px;font-size:12px;color:#d6d0ff;">Humidity 35% · Wind 3.9 km/h</div>
=======
    <div style="font-size:12px;color:#9c98ad;">Updated 2026-03-24T16:15</div>
    <div style="margin-top:8px;font-size:12px;color:#d6d0ff;">Humidity 35% · Wind 3.9 km/h</div>
>>>>>>> fd553ca ([astro-refactor] Restructure project root, fix API path, update deploy pipeline, and improve README with API usage instructions)
  </div>
</div>
...
| --- | --- | --- | --- | --- | --- | --- |
<<<<<<< HEAD
| 2026-03-24T16:15 | 18.1 | 35 | 3.9 | 214 | 0.0 | 0 ☀️ |
=======
| 2026-03-24T16:15 | 18.1 | 35 | 3.9 | 214 | 0.0 | 0 ☀️ |
>>>>>>> fd553ca ([astro-refactor] Restructure project root, fix API path, update deploy pipeline, and improve README with API usage instructions)
<!-- WEATHER:END -->
